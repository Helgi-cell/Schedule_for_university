...
@Configuration
@EnableKafka
public class RequestFromLectorKafkaConsumerConfigRest {

    @Value(value = "${kafka.bootstrapAddress}")
    private String bootstrapAddress;
    private String requestfromlector = "requestfromlector";
    private String listrequestfromlectorlector = "listrequestfromlector";
    ...
    public ConsumerFactory<String, RequestFromLector> requestFromLectorConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, requestfromlector);
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(RequestFromLector.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, RequestFromLector> requestFromLectorKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, RequestFromLector> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    public ConsumerFactory<String, List<RequestFromLector>> listRequestFromLectorConsumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, listrequestfromlectorlector);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        props.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class);
